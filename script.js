...
document.querySelector('.accidental').click(function () {
    console.log(true);
});
...
function test1() {
    ...
    li.style.color = "red";
    arrayImagenes[contado].appendChild(li);
    arrayI[contado1].appendChild(li);
    contado++;contado1++;


    console.log(arrayImagenes[contado]);
...
$(function () {
    ...
    $('div').on('click','.accidental', function(){
        console.log(arrayImagenes[1]);
    });
    ...
    $('.accidental').trigger('click');

    $('#keyboard').children('div').each(function (index, element) {

        arrayImagenes[index] = element;
    });

    $('.machine-bg .player').children('div').each(function (index, element) {

        arrayI[index] = element;
    });
